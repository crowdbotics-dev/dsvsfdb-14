"""
Django settings for dsvsfdb_14 project.
...
WSGI_APPLICATION = 'dsvsfdb_14.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dsvsfdb_14 API",
    "DESCRIPTION": "API documentation for dsvsfdb_14 App",
    "VERSION": "v1",
}
